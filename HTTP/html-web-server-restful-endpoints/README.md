...
- Log In -> `GET /login`
- Log Out -> `POST /logout`
- Access the comments for a post page -> `GET /post/:postID/comments`
- Access the create page for a post's comment -> `GET /post/:postID/comments/new`
